...
export class HR_CovidTestService {
list: HR_CovidTest[];
formData: HR_CovidTest;
aPIURL: string = environment.APIURL;
controller: string = "HR_CovidTest";
