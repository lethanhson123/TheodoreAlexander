...
import { HR_Duty } from 'src/app/shared/HR_Duty.model';
@Injectable({
providedIn: 'root'
})
export class HR_DutyService {
list: HR_Duty[];
formData: HR_Duty;
aPIURL: string = environment.APIURL;
controller: string = "HR_Duty";
