...
import { HR_Employee_HistoryWork } from 'src/app/shared/HR_Employee_HistoryWork.model';
@Injectable({
providedIn: 'root'
})
export class HR_Employee_HistoryWorkService {
list: HR_Employee_HistoryWork[];
formData: HR_Employee_HistoryWork;
aPIURL: string = environment.APIURL;
controller: string = "HR_Employee_HistoryWork";
