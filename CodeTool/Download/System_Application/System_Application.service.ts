...
export class System_ApplicationService {
list: System_Application[];
formData: System_Application;
aPIURL: string = environment.APIURL;
controller: string = "System_Application";
