...
export class HR_Recruitment_IntroduceService {
list: HR_Recruitment_Introduce[];
formData: HR_Recruitment_Introduce;
aPIURL: string = environment.APIURL;
controller: string = "HR_Recruitment_Introduce";
