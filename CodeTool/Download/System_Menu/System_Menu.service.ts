...
import { System_Menu } from 'src/app/shared/System_Menu.model';
@Injectable({
providedIn: 'root'
})
export class System_MenuService {
list: System_Menu[];
formData: System_Menu;
aPIURL: string = environment.APIURL;
controller: string = "System_Menu";
