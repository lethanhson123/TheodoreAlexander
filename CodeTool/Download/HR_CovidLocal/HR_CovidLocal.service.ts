...
export class HR_CovidLocalService {
list: HR_CovidLocal[];
formData: HR_CovidLocal;
aPIURL: string = environment.APIURL;
controller: string = "HR_CovidLocal";
