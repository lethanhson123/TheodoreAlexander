...
import { HR_Division } from 'src/app/shared/HR_Division.model';
@Injectable({
providedIn: 'root'
})
export class HR_DivisionService {
list: HR_Division[];
formData: HR_Division;
aPIURL: string = environment.APIURL;
controller: string = "HR_Division";
