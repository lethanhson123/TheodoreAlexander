...
import { HR_GroupName } from 'src/app/shared/HR_GroupName.model';
@Injectable({
providedIn: 'root'
})
export class HR_GroupNameService {
list: HR_GroupName[];
formData: HR_GroupName;
aPIURL: string = environment.APIURL;
controller: string = "HR_GroupName";
