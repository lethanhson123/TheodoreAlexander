...
import { HR_TeamName } from 'src/app/shared/HR_TeamName.model';
@Injectable({
providedIn: 'root'
})
export class HR_TeamNameService {
list: HR_TeamName[];
formData: HR_TeamName;
aPIURL: string = environment.APIURL;
controller: string = "HR_TeamName";
