...
export class HR_DistrictService {
list: HR_District[];
formData: HR_District;
aPIURL: string = environment.APIURL;
controller: string = "HR_District";
