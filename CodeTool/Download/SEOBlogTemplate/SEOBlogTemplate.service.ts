...
export class SEOBlogTemplateService {
list: SEOBlogTemplate[];
formData: SEOBlogTemplate;
aPIURL: string = environment.APIURL;
controller: string = "SEOBlogTemplate";
