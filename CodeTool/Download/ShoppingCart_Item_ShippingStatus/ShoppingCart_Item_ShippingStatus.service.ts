...
import { ShoppingCart_Item_ShippingStatus } from 'src/app/shared/ShoppingCart_Item_ShippingStatus.model';
@Injectable({
providedIn: 'root'
})
export class ShoppingCart_Item_ShippingStatusService {
list: ShoppingCart_Item_ShippingStatus[];
formData: ShoppingCart_Item_ShippingStatus;
aPIURL: string = environment.APIURL;
controller: string = "ShoppingCart_Item_ShippingStatus";
