...
import { HR_Department } from 'src/app/shared/HR_Department.model';
@Injectable({
providedIn: 'root'
})
export class HR_DepartmentService {
list: HR_Department[];
formData: HR_Department;
aPIURL: string = environment.APIURL;
controller: string = "HR_Department";
