...
export class HR_CovidTypeService {
list: HR_CovidType[];
formData: HR_CovidType;
aPIURL: string = environment.APIURL;
controller: string = "HR_CovidType";
