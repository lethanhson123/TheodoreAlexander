...
import { HR_BlockName } from 'src/app/shared/HR_BlockName.model';
@Injectable({
providedIn: 'root'
})
export class HR_BlockNameService {
list: HR_BlockName[];
formData: HR_BlockName;
aPIURL: string = environment.APIURL;
controller: string = "HR_BlockName";
