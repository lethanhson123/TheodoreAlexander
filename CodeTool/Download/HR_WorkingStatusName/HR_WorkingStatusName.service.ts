...
import { HR_WorkingStatusName } from 'src/app/shared/HR_WorkingStatusName.model';
@Injectable({
providedIn: 'root'
})
export class HR_WorkingStatusNameService {
list: HR_WorkingStatusName[];
formData: HR_WorkingStatusName;
aPIURL: string = environment.APIURL;
controller: string = "HR_WorkingStatusName";
