...
import { HR_Status } from 'src/app/shared/HR_Status.model';
@Injectable({
providedIn: 'root'
})
export class HR_StatusService {
list: HR_Status[];
formData: HR_Status;
aPIURL: string = environment.APIURL;
controller: string = "HR_Status";
