...
import { ShippingStatus } from 'src/app/shared/ShippingStatus.model';
@Injectable({
providedIn: 'root'
})
export class ShippingStatusService {
list: ShippingStatus[];
formData: ShippingStatus;
aPIURL: string = environment.APIURL;
controller: string = "ShippingStatus";
