...
@Component({
  selector: 'app-recruitment-english',
  templateUrl: './recruitment-english.component.html',
  styleUrls: ['./recruitment-english.component.scss']
})
export class RecruitmentEnglishComponent implements OnInit {
