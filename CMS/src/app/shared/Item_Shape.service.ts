...
export class Item_ShapeService {
    list: Item_Shape[] | undefined;
    formData!: Item_Shape;
    aPIURL: string = environment.APIURL;
    controller: string = "Item_Shape";
    ...
    insertBySQL(formData: Item_Shape) {
        let url = this.aPIURL + this.controller + '/InsertBySQL';
        return this.httpClient.post(url, formData);
    }
    deleteBySQL(Item_ID: any, Shape_ID: any) {
