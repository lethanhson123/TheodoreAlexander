...
export class LifeStyleService {
    list: LifeStyle[] | undefined;
    formData!: LifeStyle;
    aPIURL: string = environment.APIURL;
    controller: string = "LifeStyle";
    ...
    add(formData: LifeStyle) {
        let url = this.aPIURL + this.controller + '/Add';
        return this.httpClient.post(url, formData);
    }
    addAndUploadImage(formData: LifeStyle, fileToUpload: File, fileToUploadImageName: File) {
