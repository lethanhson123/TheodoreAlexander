...
export class ShapeDetailComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ShapeDetailComponent>,
  ...
  onSubmit(form: NgForm) {
    this.shapeService.addAndUploadImage(form.value, this.fileToUpload, this.fileToUploadImageName).subscribe(
      res => {
