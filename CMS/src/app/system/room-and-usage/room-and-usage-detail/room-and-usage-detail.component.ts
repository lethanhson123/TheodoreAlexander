...
@Component({
  selector: 'app-room-and-usage-detail',
  templateUrl: './room-and-usage-detail.component.html',
  styleUrls: ['./room-and-usage-detail.component.css']
})
export class RoomAndUsageDetailComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<RoomAndUsageDetailComponent>,
  ...
  onSubmit(form: NgForm) {
    this.roomAndUsageService.addAndUploadImage(form.value, this.fileToUpload, this.fileToUploadImageName).subscribe(
      res => {
