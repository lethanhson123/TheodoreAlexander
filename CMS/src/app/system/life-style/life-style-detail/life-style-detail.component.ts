...
@Component({
  ...
  styleUrls: ['./life-style-detail.component.css']
})
export class LifeStyleDetailComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<LifeStyleDetailComponent>,
  ...
  onSubmit(form: NgForm) {
    this.lifeStyleService.addAndUploadImage(form.value, this.fileToUpload, this.fileToUploadImageName).subscribe(
      res => {
