...
@Component({
  selector: 'app-bed-infomation',
  templateUrl: './bed-infomation.component.html',
  styleUrls: ['./bed-infomation.component.css']
})
export class BedInfomationComponent implements OnInit {
  ...
  onSubmitBedInfomation() {
    let fileToUpload: File;
    fileToUpload = this.uploadItem.nativeElement.files[0];    
    this.isShowLoading = true;
    this.uploadService.postItemBedInfomationByExcelFile(fileToUpload).subscribe(
      data => {         
