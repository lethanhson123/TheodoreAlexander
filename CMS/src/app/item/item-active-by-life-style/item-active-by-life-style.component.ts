...
@Component({
  selector: 'app-item-active-by-life-style',
  templateUrl: './item-active-by-life-style.component.html',
  styleUrls: ['./item-active-by-life-style.component.css']
})
export class ItemActiveByLifeStyleComponent implements OnInit {
  ...
  getToList() {
    if (this.lifeStyle_IDList) {
      if (this.lifeStyle_IDList.length > 0) {
        this.isShowLoading = true;
