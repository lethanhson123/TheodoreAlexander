...
@Component({
  selector: 'app-is-best-seller',
  templateUrl: './is-best-seller.component.html',
  styleUrls: ['./is-best-seller.component.css']
})
export class IsBestSellerComponent implements OnInit {
  ...
  onSubmitItem() {
    ...
    this.uploadService.postItemIsBestSellerByExcelFile(fileToUpload).subscribe(
      data => {         
