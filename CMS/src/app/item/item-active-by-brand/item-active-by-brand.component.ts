...
@Component({
  selector: 'app-item-active-by-brand',
  templateUrl: './item-active-by-brand.component.html',
  styleUrls: ['./item-active-by-brand.component.css']
})
export class ItemActiveByBrandComponent implements OnInit {
  ...
  getToList() {
    if (this.brand_IDList) {
      if (this.brand_IDList.length > 0) {
        this.isShowLoading = true;
