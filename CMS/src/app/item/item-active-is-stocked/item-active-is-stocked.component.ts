...
@Component({
  selector: 'app-item-active-is-stocked',
  templateUrl: './item-active-is-stocked.component.html',
  styleUrls: ['./item-active-is-stocked.component.css']
})
export class ItemActiveIsStockedComponent implements OnInit {
