...
@Component({
  selector: 'app-item-active-is-best-seller',
  templateUrl: './item-active-is-best-seller.component.html',
  styleUrls: ['./item-active-is-best-seller.component.css']
})
export class ItemActiveIsBestSellerComponent implements OnInit {
