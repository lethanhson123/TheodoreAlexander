...
@Component({
  selector: 'app-item-active-extending',
  templateUrl: './item-active-extending.component.html',
  styleUrls: ['./item-active-extending.component.css']
})
export class ItemActiveExtendingComponent implements OnInit {
