...
@Component({
  selector: 'app-item-active-is-new',
  templateUrl: './item-active-is-new.component.html',
  styleUrls: ['./item-active-is-new.component.css']
})
export class ItemActiveIsNewComponent implements OnInit {
