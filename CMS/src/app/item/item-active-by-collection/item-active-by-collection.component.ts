...
@Component({
  selector: 'app-item-active-by-collection',
  templateUrl: './item-active-by-collection.component.html',
  styleUrls: ['./item-active-by-collection.component.css']
})
export class ItemActiveByCollectionComponent implements OnInit {
  ...
  getToList() {
    if (this.collection_IDList) {
      if (this.collection_IDList.length > 0) {
        this.isShowLoading = true;
