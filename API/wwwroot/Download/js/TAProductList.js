...
function onViewUS() {
    ...
    document.getElementById("ProductListIsStockedMobile").hidden = false;
...
function onViewInternational() {
    ...
    document.getElementById("ProductListIsStockedMobile").hidden = true;
...
function getByQueryString001() {
    ...
    var url = "https://api.theodorealexander.com/api/Item/AsyncGetDataTransferByUser_IDAndRegionAndFiltersToList";
    $.ajax({
        type: "GET",
        url: url,
        data: {
