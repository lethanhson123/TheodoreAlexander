...
function onSlides001PREV() {
    ...
    $last.animate({ 'margin-left': '0px' }, 150);
}
function onSlides001NEXT() {
    var width = window.innerWidth - 500;
    width = width * -1;
    var $first = $('#Slides001 div.swiper-slide:first');
    $first.animate({ 'margin-left': width }, 150, function () {
...
function onInitializationPage() {    
    ...
    if ((pathname == "/") || (pathname == "/index.html") || (pathname == "")) {
        $('head').append('<link rel="stylesheet" href="css/menuMobile.css?v=2021102616" />');
        $('head').append('<link rel="stylesheet" href="css/headerMobile.css?v=2021102616" />');
        document.getElementById("MainContent").hidden = true;
        document.getElementById("MainContentHTML").hidden = false;
    }
    else {
        document.getElementById("MainContentHTML").hidden = true;
...
function onViewUS() {
    ...
    document.getElementById("Slides001International").hidden = true;
    document.getElementById("Slides002International").hidden = true;
    ...
    document.getElementById("Slides001US").hidden = false;
    document.getElementById("Slides002US").hidden = false;
...
function onViewInternational() {
    ...
    document.getElementById("Slides001International").hidden = false;
    document.getElementById("Slides002International").hidden = false;
    ...
    document.getElementById("Slides001US").hidden = true;
    document.getElementById("Slides002US").hidden = true;
