...
function onSearchOpen() {
    ...
    if (value) {
        window.location.href = 'http://web-test.theodorealexander.com/product-listing;OrderBy=IsNew;requestCount=1;SearchKey=' + value;
    }
}
...
function onHeaderSearchInputEnter(ele) {
    if (event.key === 'Enter') {
        if (ele.value) {
            window.location.href = 'http://web-test.theodorealexander.com/product-listing;OrderBy=IsNew;requestCount=1;SearchKey=' + ele.value;
        }
    }
}
...
function onSwitchToProductListing(countBy) {
    var url = "http://web-test.theodorealexander.com/product-listing;OrderBy=IsNew;DefaultItemOnly=true;countBy=" + countBy;
    if (countBy == "ClearAll") {
        url = "http://web-test.theodorealexander.com/product-listing;OrderBy=IsNew;requestCount=1;DefaultItemOnly=true";
