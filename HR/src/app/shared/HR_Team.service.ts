...
import { HR_Team } from 'src/app/shared/HR_Team.model';
@Injectable({
    providedIn: 'root'
})
export class HR_TeamService {
    list: HR_Team[] | undefined;
    formData: HR_Team | undefined;
    aPIURL: string = environment.APIURL;
    controller: string = "HR_Team";
