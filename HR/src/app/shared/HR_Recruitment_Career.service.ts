...
export class HR_Recruitment_CareerService {  
  list: HR_Recruitment_Career[] | undefined;
  formData: HR_Recruitment_Career | undefined;
  ...
  asyncSendMailByIDAny(ID: any) {
    let url = this.aPIURL + this.controller + '/AsyncSendMailByID';
    const params = new HttpParams()
