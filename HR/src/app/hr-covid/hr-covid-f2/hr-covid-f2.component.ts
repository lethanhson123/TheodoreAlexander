...
@Component({
  selector: 'app-hr-covid-f2',
  templateUrl: './hr-covid-f2.component.html',
  styleUrls: ['./hr-covid-f2.component.css']
})
export class HRCovidF2Component implements OnInit {
  ...
  getToList() {    
    this.hR_CovidService.getByF2ToList().then(res => {
