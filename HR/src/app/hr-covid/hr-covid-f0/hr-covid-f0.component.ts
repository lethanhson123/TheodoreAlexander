...
@Component({
  selector: 'app-hr-covid-f0',
  templateUrl: './hr-covid-f0.component.html',
  styleUrls: ['./hr-covid-f0.component.css']
})
export class HRCovidF0Component implements OnInit {
  ...
  getToList() {    
    this.hR_CovidService.getByF0ToList().then(res => {
